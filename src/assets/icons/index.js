...
export const IconPlaceholder = ({ name, className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 12m-9 0a9 9 0 1018 0a9 9 0 10-18 0"></path>
    <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="#fff" fontSize="10">
      {name.substring(0,1)}
    </text>
  </svg>
);
